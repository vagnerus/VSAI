      ...
      <div className="auth-container">
        <div className="auth-card">
          ...
          <div className="auth-switch">
            {mode === 'login' && (
              <>Não tem conta? <button onClick={() => { setMode('register'); setError(''); }}>Criar conta</button></>
            )}
            {mode === 'register' && (
              <>Já tem conta? <button onClick={() => { setMode('login'); setError(''); }}>Entrar</button></>
            )}
            {mode === 'forgot' && (
              <>Lembrou? <button onClick={() => { setMode('login'); setError(''); }}>Voltar ao login</button></>
            )}
          </div>
        </div>
      </div>
